...
/// an encrypted copy of the verifier marker (so a wrong password is
...
pub struct Verifier {
    ...
    pub salt: String,
    /// The verifier marker encrypted under the derived key, hex-encoded.
    pub check: String,
}
